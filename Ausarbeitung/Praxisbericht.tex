...
% ---- Persönlichen Daten:
\newcommand{\titel}{Evaluationsmetriken von ML Algorithmen für Clustering, Klassifikation und Regression}
\newcommand{\titelheader}{}
\newcommand{\arbeit}{Ausarbeitung}
\newcommand{\studiengang}{Wirtschaftsinformatik}
\newcommand{\studienjahr}{2023}
\newcommand{\autor}{Jens Feser}
\newcommand{\autorReverse}{Feser, Jens}
\newcommand{\verfassungsort}{Mannheim}
\newcommand{\matrikelnr}{8658477}
\newcommand{\kurs}{WWI22SEB}
\newcommand{\bearbeitungsmonat}{}
\newcommand{\abgabe}{}
...
\input{Inhalt/00_Latex/kopfundFusszeile} % Kopf- und Fußzeile
...
\include{Inhalt/01_Standard/disclaimer}
...
\include{Inhalt/04_Inhalt/Clustering}
\include{Inhalt/04_Inhalt/Klassifikation}
\include{Inhalt/04_Inhalt/Regression}
